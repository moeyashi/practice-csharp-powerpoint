...
{
    SlideMasterIdList slideMasterIdList1 = new(new SlideMasterId() { Id = (UInt32Value)2147483648U, RelationshipId = "rId1" });
    SlideIdList slideIdList1 = new(new SlideId() { Id = (UInt32Value)256U, RelationshipId = "rId2" });
    SlideSize slideSize1 = new() { Cx = 9144000, Cy = 6858000, Type = SlideSizeValues.Screen4x3 };
    NotesSize notesSize1 = new() { Cx = 6858000, Cy = 9144000 };
    DefaultTextStyle defaultTextStyle1 = new();
